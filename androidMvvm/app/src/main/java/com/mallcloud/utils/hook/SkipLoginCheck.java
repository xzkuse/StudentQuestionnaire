package com.mallcloud.utils.hook;
...
public class SkipLoginCheck implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam loadPackageParam) throws Throwable {
        ...
        XposedBridge.log("开始 hook location: " );
        hook_method("android.net.wifi.WifiManager", mLpp.classLoader, "getScanResults",
                    new XC_MethodHook(){
                        ...
                        protected void afterHookedMethod(MethodHookParam param)
                            ...
                            XposedBridge.log("开始 WifiManager: " );
        ...
        hook_method("android.telephony.TelephonyManager", mLpp.classLoader, "getCellLocation",
                    new XC_MethodHook(){
                        ...
                        protected void afterHookedMethod(MethodHookParam param)
                            throws Throwable {
                            XposedBridge.log("开始 TelephonyManager: " );
                            param.setResult(null);
                        }
                    });
        ...
        hook_methods("android.location.LocationManager", "requestLocationUpdates",
                     new XC_MethodHook() {
                         ...
                         protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                             ...
                             XposedBridge.log("开始 LocationManager  requestLocationUpdates: " );
        ...
        hook_methods("android.location.LocationManager", "getGpsStatus",
                     new XC_MethodHook(){
                         ...
                         protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                             XposedBridge.log("开始 getGpsStatus: " );
